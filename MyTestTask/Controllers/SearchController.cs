...
using MyTestTask.dto.SearchFolder.Request;
using MyTestTask.dto.SearchFolder.Response;
    ...
    public class SearchController : Controller
    {
        ...
        public async Task<ActionResult<List<SearchCriteriaResponse>>> Search([FromQuery] SearchCriteriaRequest ct)
        {
            ...
            else
            {
                if (preliminary != null)
                {
                    preliminary = (DbSet<Advertising>)preliminary.Where(x => ct != null && x.City == ct.City);
                }
            }
            ...
            else
            {
                if (preliminary != null)
                {
                    preliminary = (DbSet<Advertising>)preliminary.Where(x => ct != null && x.Category == ct.Category);
                }
            }
            ...
            else
            {
                if(preliminary != null)
                {
                    preliminary = (DbSet<Advertising>)preliminary.Where(x => ct != null && x.Subcategory == ct.SubCategory);
                }
            }
